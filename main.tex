...
\begin{tikzpicture}[>=Stealth, font=\small, scale=1]
  ...
  \draw[ultra thick,blue,->] (C) -- (F);
  \draw[ultra thick,blue,->] (F) -- (J);
  \draw[ultra thick,blue,->] (J) -- (L);
  \draw[ultra thick,blue,->] (L) -- (T);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[>=Stealth, font=\small, scale=1]
  ...
  \draw[ultra thick,blue,->] (A) -- (C);
  \draw[ultra thick,blue,->] (C) -- (F);
  \draw[ultra thick,blue,->] (F) -- (G);
  \draw[ultra thick,blue,->] (G) -- (H);
  \draw[ultra thick,blue,->] (H) -- (K);
  \draw[ultra thick,blue,->] (K) -- (M);
  \draw[ultra thick,blue,->] (M) -- (T);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[>=Stealth, font=\small, scale=1]
  ...
  \draw[ultra thick,blue,->] (S) -- (A);
  \draw[ultra thick,blue,->] (A) -- (C);
  \draw[ultra thick,blue,->, bend left=35] (C) -- (H);
  \draw[ultra thick,blue,->, bend left=10] (H) -- (T);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[>=Stealth, font=\small, scale=1]
  ...
  % destaque
  \draw[ultra thick,blue,->] (S) -- (B);
  \draw[ultra thick,blue,->] (B) -- (D);
  \draw[ultra thick,blue,->] (D) -- (I);
  \draw[ultra thick,blue,->] (I) -- (K);
  \draw[ultra thick,blue,->] (K) -- (M);
  \draw[ultra thick,blue,->] (M) -- (T);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[>=Stealth, font=\small, scale=1]
  ...
  \draw[ultra thick,blue,->] (B) -- (D);
  \draw[ultra thick,blue,->] (D) -- (I);
  \draw[ultra thick,blue,->, bend left=10] (I) -- (H);
  \draw[ultra thick,blue,->] (H) -- (K);
  \draw[ultra thick,blue,->] (K) -- (M);
  \draw[ultra thick,blue,->] (M) -- (T);
\end{tikzpicture}
